...
Only ports bound to a public interface (`0.0.0.0`, `::`, `*`) are shown; loopback listeners are hidden. Unsupported filter values return an error, and the default `inventory scan` output is unchanged.
