...
go install github.com/Higangssh/homebutler@v0.36.0
```
...
# must print: homebutler_0.36.0_linux_amd64.tar.gz: OK
tar xzf homebutler_${V}_linux_amd64.tar.gz
```

There is a container image, `ghcr.io/higangssh/homebutler:0.36.0`, pinned the
same way.
